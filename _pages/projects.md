...
- **[ollama.qqgjyx.com](https://ollama.qqgjyx.com){:target="_blank"}**: An open web UI running a pre-tuned language model specializing as an AI chatbot, serving as a replacement for Juntang.